...
El script ejecucion.py crea motores independientes, los instala dentro de coches y motos, y finalmente demuestra cómo interactúan todas las partes imprimiendo sus estados y acciones.
